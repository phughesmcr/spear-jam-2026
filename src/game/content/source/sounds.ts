...
import { SoundId, type SoundId as SoundIdType } from "@/src/game/model/sound.ts";
...
const ERROR = new URL("../../../../assets/game/audio/error.mp3", import.meta.url).href;
...
export const SHIPPED_SOUND_ENTRIES: Readonly<Record<SoundIdType, SoundCatalogEntry>> = {
  [SoundId.BlockedMove]: sfx(SoundId.BlockedMove, BLOCKED_MOVE, 0.45, 2),
  [SoundId.DoorOpen]: sfx(SoundId.DoorOpen, DOOR_OPEN, 0.75, 5),
  [SoundId.DoorLocked]: sfx(SoundId.DoorLocked, ERROR, 0.65, 3),
  ...
  [SoundId.TerminalLocked]: sfx(SoundId.TerminalLocked, ERROR, 0.55, 4),
