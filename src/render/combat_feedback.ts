import type { CombatFeedback, CombatFeedbackSide, CombatFeedbackTone } from "@/src/game/combat_feedback.ts";
...
const combatPanelAsset = createImageAsset(new URL("../../assets/game/ui/combat_stats_box.png", import.meta.url).href);
