...
import { renderPlanes } from "@/src/engine/raycast/cast_planes.ts";
import { renderSpritesAndThinWalls } from "@/src/engine/raycast/cast_sprites.ts";
import { renderWalls } from "@/src/engine/raycast/cast_walls.ts";
import {
  assertFrameCapacity,
